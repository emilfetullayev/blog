        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row w-25 mb-3">
                    <a class="btn btn-block btn-success" href="{{ route('tag.create') }}">Create</a>
                </div>
                <!-- Main row -->
                <div class="col-12">
                    <div class="card">
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                @foreach($tags as $tag)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('tag.show', $tag->id) }}" style="display: block; cursor: pointer">
                                                <img src="{{ asset('assets/images/eye-solid.svg') }}" alt="show" style="width: 20px; height: 20px">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="{{ route('tag.edit', $tag->id) }}" style="display: block; cursor: pointer">
